...
print(instancia_datos.tablon_vendedores.shape)
instancia_datos.tablon_vendedores.iloc[:,1:5]

# COMMAND ----------

print(instancia_datos.tablon_vendedores.shape)
print(instancia_datos.tablon_vendedores[~instancia_datos.tablon_vendedores.iloc[:,1:108].duplicated(keep='first')])
instancia_datos.tablon_vendedores[~instancia_datos.tablon_vendedores.iloc[:,1:108].duplicated(keep='first')]
...
fichero = '/dbfs/FileStore/tables/ONCE_Quantum/GESTIÓN_COBERTURA_NE11__2022_01_03_.xlsx'
vendedores = pd.read_excel(fichero, engine='openpyxl', sheet_name = 'GESCOM', header = [0])
vendedores
